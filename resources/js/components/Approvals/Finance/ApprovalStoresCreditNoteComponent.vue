            ...
            <div class="row justify-content-center" v-if="request">
                <div class="col-md-8 px-8">
                    ...
                    <div class="row text-dark justify-content-center px-20 mb-2">
                        ...
                        <div class="col-md-6">
                            <small>Account Code</small><br/><strong>{{request.account_code}}</strong>
                        </div>
                        <div class="col-md-6">
                           <small>Capital Expenditure Approval No</small><br/> <strong>{{request.capital_exp_app_no}}</strong>
                        </div>

                    </div>
                    <div class="row text-dark px-20 mb-2">
                          <div class="col-md-6">
                            <small>Rechargeable works order No </small><br/><strong>{{request.rechargeable_works_order_no}}</strong>
                         </div>
                         <div class="col-md-6">
                          <small>Job from which returned</small><br/><strong>{{request.job_returned}}</strong>
                          </div>
                    </div>
