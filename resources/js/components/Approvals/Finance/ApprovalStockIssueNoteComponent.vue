            ...
            <div class="row justify-content-center" v-if="request">
                <div class="col-md-8 px-8">
                    ...
                    <div class="row text-dark justify-content-center px-20 mb-2">
                        ...
                        <div class="col-md-4">
                            <small>Requested By</small><br/><strong>{{request.requested_by}}</strong>
                        </div>
                        <div class="col-md-4">
                           <small>Cost Center</small><br/> <strong>{{request.cost_center}}</strong>
                        </div>
                        <div class="col-md-4">
                           <small>Project Type</small><br/> <strong>{{request.project_type}}</strong>
                        </div>
                    ...
                    <div class="row text-dark justify-content-center px-20 mb-2">
                        ...
                        <div class="col-md-4">
                           <small>Budget No</small><br/> <strong>{{request.budget_no}}</strong>
                        </div>
                        <div class="col-md-4">
                           <small>Destination</small><br/> <strong>{{request.destination}}</strong>
                        </div>
                    </div>
                    <div class="row text-dark justify-content-center px-20 mb-2">
                        <div class="col-md-6">
                            <small>Requisition Purpose</small><br/><strong>{{request.requisition_purpose}}</strong>
                        </div>
                    </div>
                                      ...
                                      <table class="table table-bordered" width="100%">
                                          ...
                                          <tbody >
                                              <tr v-for="(input,k) in request.stock" :key="k">
                                                  ...
                                                  <td>{{input.desc}}</td>
                                                  <td>{{input.qty_req}}</td>
                                                  <td>{{input.qty_issued}}</td>
                                                  <td>{{input.unit_price}}</td>
                                                  <td>{{input.total_value}}</td>
