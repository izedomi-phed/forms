                ...
                <div class="row px-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="designation">Account Code<span class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" v-model="details.account_code" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="firstName">Capital Expenditure Approval No<span class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="firstName" v-model="details.capital_exp_app_no" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="designation">Rechargeable works order No:<span class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" v-model="details.rechargeable_works_order_no" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="officer_email">Job from which returned<span class="text-danger">*</span></label>
                            <textarea class="form-control form-control-sm" v-model="details.job_returned"></textarea>
                        </div>
                    </div>
                                ...
                                <table class="table table-bordered" width="100%">
                                    ...
                                    <tbody >
                                        <tr v-for="(input,k) in p" :key="k">
                                            ...
                                            <td>
                                                <textarea v-model="input.desc" class="form-control" required></textarea>
                                            </td>
                                            <td><input type="number" min="0" class="form-control" v-model="input.unit" required></td>
            ...
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control form-control-sm" id="firstName" v-model="details.total" required>
                        </div>
                    </div>
